...
func TruncateAll(t *testing.T, pool *pgxpool.Pool) {
	t.Helper()
	_, err := pool.Exec(context.Background(), `TRUNCATE ledger_entries, idempotency_keys, outbox, webhook_deliveries, webhook_endpoints, transactions, accounts, users CASCADE`)
	if err != nil {
